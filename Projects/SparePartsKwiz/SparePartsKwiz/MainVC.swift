...
//
        ...
        let vc = viewController(for: Game.shared.currentQuestion)
    ...
    func viewController(for question: Question?) -> UIViewController {
        switch question {
        case is MultipleChoiceQuestion: return MultipleChoiceVC()
        case is LockQuestion: return LockVC()
        case is ScaleQuestion: return ScaleVC()
        case .none: return ResultsVC()
        default:
            assertionFailure("Unknown question type")
