...
//    private func handleCreateAccountResponce(with result: Result<User,Error>) {
//        switch result {
//        case .success(let user):
//            let appUser = AppUser.init(from: user)
//            FirestoreService.manager.createAppUser(user: appUser) { (error) in
//                print(error)
//                return
//            }
